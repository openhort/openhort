...
from hort.extensions.core.macos_statusbar.provider import (
    HEADER_NAME,
...
class TestSharedKeyFile:
    ...
    def test_creates_key_when_missing(self, tmp_path: Path) -> None:
        ...
        with patch(
            "hort.extensions.core.macos_statusbar.provider._KEY_FILE", key_file
        ):
...
class TestStatusBar:
    ...
    @patch("hort.extensions.core.macos_statusbar.provider.get_or_rotate_key", return_value="k")
    @patch("hort.extensions.core.macos_statusbar.provider._STATUSBAR_BIN")
...
class TestVerifyEndpoint:
    @patch(
        "hort.extensions.core.macos_statusbar.provider.get_or_rotate_key",
    ...
    def test_verify_timing_safe(self) -> None:
        import inspect
        from hort.extensions.core.macos_statusbar import provider
