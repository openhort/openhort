...
class TestMatchFilter:
    ...
    def test_exact_match(self) -> None:
        from llmings.core.llming_lens.llming_lens import _match_filter
    ...
    def test_matches_any(self) -> None:
        from llmings.core.llming_lens.llming_lens import _matches_any
    ...
    def test_filter_windows(self) -> None:
        from llmings.core.llming_lens.llming_lens import _filter_windows
...
class TestGridAnnotation:
    ...
    def test_annotate_grid(self) -> None:
        ...
        from llmings.core.llming_lens.llming_lens import _annotate_grid
    ...
    def test_grid_cell_to_region(self) -> None:
        from llmings.core.llming_lens.llming_lens import LlmingLens
...
class TestLlmingLensTools:
    ...
    def test_list_windows_with_mock(self) -> None:
        ...
        with patch("llmings.core.llming_lens.llming_lens.list_windows", return_value=mock_windows, create=True):
...
class TestUserActivity:
    ...
    def test_user_recently_active_function_exists(self) -> None:
        from llmings.core.llming_lens.llming_lens import _user_recently_active
